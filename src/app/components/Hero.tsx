    ...
    <section id="hero" className="lg:grid lg:grid-cols-2 relative min-h-screen">
      ...
      <div className="relative">
        ...
        <div className="flex justify-center relative z-10 items-center lg:h-full h-screen">
          <div className="max-w-[90vw] flex flex-col items-center justify-center gap-10">
            ...
            <h2 className="text-center text-2xl md:text-4xl lg:text-8xl leading-none font-jetbrainsMono text-primary">
              Nilay Saxena
            </h2>
            <div className="text-center mt-4 md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl font-jetbrainsMono">
